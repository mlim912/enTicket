    ...
    public class AppDbinitializer
    {
        ...
        public static async  Task SeedUsersAndRolesAsync(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                string adminUserEmail = "admin@enticket.com";
                var adminUser = await userManager.FindByEmailAsync("admin@enticket.com");
                if (adminUser == null)
                {
                ...
                string appUserEmail = "user@enticket.com";
                var appUser = await userManager.FindByEmailAsync("user@enticket.com");
                if (appUser == null)
                {
